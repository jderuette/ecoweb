title=Composant subContent : exemples : Table (avec contenu additionnel), contenu link
date=2025-10-28
...
status=published
exerpt=Un Exemple de subContent sous forme de tableau (link) avec données additionelles
