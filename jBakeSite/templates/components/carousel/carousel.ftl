...
<#macro build content>
	<#if (content.carouselData)??>
		<#local slides=(content.carouselData.slides)! />
		<#local carouselId=(content.carouselData.id)!common.randomNumber() />
		<#local controls=(content.carouselData.controls)! />
		<#local displayIndicator=(content.carouselData.displayIndicator)!false />
		<#local carouselStyle=(content.carouselData.style)! />
